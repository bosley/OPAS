...
${OBJECTDIR}/ALGO/ContourAnalyzation.o: ALGO/ContourAnalyzation.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ALGO/ContourAnalyzation.o ALGO/ContourAnalyzation.cpp

${OBJECTDIR}/ALGO/Sobel.o: ALGO/Sobel.cpp
	${MKDIR} -p ${OBJECTDIR}/ALGO
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ALGO/Sobel.o ALGO/Sobel.cpp

${OBJECTDIR}/IPF/Series.o: IPF/Series.cpp
	${MKDIR} -p ${OBJECTDIR}/IPF
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IPF/Series.o IPF/Series.cpp

${OBJECTDIR}/UTIL/CameraSource.o: UTIL/CameraSource.cpp
	${MKDIR} -p ${OBJECTDIR}/UTIL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UTIL/CameraSource.o UTIL/CameraSource.cpp
