...
${OBJECTDIR}/blocker/Blocker.o: blocker/Blocker.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/blocker/Blocker.o blocker/Blocker.cpp

${OBJECTDIR}/ckey/ckey.o: ckey/ckey.cpp
	${MKDIR} -p ${OBJECTDIR}/ckey
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ckey/ckey.o ckey/ckey.cpp

${OBJECTDIR}/cmac/NetAdapter/NetAdapter_Shared.o: cmac/NetAdapter/NetAdapter_Shared.cpp
	${MKDIR} -p ${OBJECTDIR}/cmac/NetAdapter
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmac/NetAdapter/NetAdapter_Shared.o cmac/NetAdapter/NetAdapter_Shared.cpp

${OBJECTDIR}/cmac/NetAdapter/NetAdapter_Stub.o: cmac/NetAdapter/NetAdapter_Stub.cpp
	${MKDIR} -p ${OBJECTDIR}/cmac/NetAdapter
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmac/NetAdapter/NetAdapter_Stub.o cmac/NetAdapter/NetAdapter_Stub.cpp

${OBJECTDIR}/cmac/NetAdapter/NetAdapter_Unix.o: cmac/NetAdapter/NetAdapter_Unix.cpp
	${MKDIR} -p ${OBJECTDIR}/cmac/NetAdapter
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmac/NetAdapter/NetAdapter_Unix.o cmac/NetAdapter/NetAdapter_Unix.cpp

${OBJECTDIR}/cmac/NetAdapter/NetAdapter_Win32.o: cmac/NetAdapter/NetAdapter_Win32.cpp
	${MKDIR} -p ${OBJECTDIR}/cmac/NetAdapter
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmac/NetAdapter/NetAdapter_Win32.o cmac/NetAdapter/NetAdapter_Win32.cpp

${OBJECTDIR}/cmac/NetAdapter/NetAdapter_WinRT.o: cmac/NetAdapter/NetAdapter_WinRT.cpp
	${MKDIR} -p ${OBJECTDIR}/cmac/NetAdapter
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmac/NetAdapter/NetAdapter_WinRT.o cmac/NetAdapter/NetAdapter_WinRT.cpp

${OBJECTDIR}/cmac/cmac.o: cmac/cmac.cpp
	${MKDIR} -p ${OBJECTDIR}/cmac
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cmac/cmac.o cmac/cmac.cpp
...
${OBJECTDIR}/host/DydnoDB.o: host/DydnoDB.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/host/DydnoDB.o host/DydnoDB.cpp

${OBJECTDIR}/host/helpers.o: host/helpers.cpp
	${MKDIR} -p ${OBJECTDIR}/host
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/host/helpers.o host/helpers.cpp
...
${OBJECTDIR}/net/RPCClient.o: net/RPCClient.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/net/RPCClient.o net/RPCClient.cpp

${OBJECTDIR}/net/RPCServer.o: net/RPCServer.cpp
	${MKDIR} -p ${OBJECTDIR}/net
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/net/RPCServer.o net/RPCServer.cpp

${OBJECTDIR}/net/dnetmsg.o: net/dnetmsg.cpp
	${MKDIR} -p ${OBJECTDIR}/net
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/net/dnetmsg.o net/dnetmsg.cpp
